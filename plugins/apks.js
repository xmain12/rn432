...
if (Config.WORKTYPE == 'private') {
   ...
   Asena.addCommand({pattern: 'waplus', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
      await message.sendMessage('💎 *WHATSAPP PLUS* 💎\nwhattsapp mod.\n📌 bit.ly/drkWaPlus');
       ...
       Asena.addCommand({pattern: 'gbwa', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
      await message.sendMessage('💎 *Gb whatsapp* 💎\GbWhatsapp.\n📌 https://bit.ly/3A47wA0');
    }));   
       
    Asena.addCommand({pattern: 'vm', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'capcut', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
   ...
   Asena.addCommand({pattern: 'ttokk', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
      await message.sendMessage('💎 *TIKTOK MOD* 💎\npremium unlocked.\n📌 bit.ly/drktiktok');
   }));
   ...
   Asena.addCommand({pattern: 'waplus', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'gbwa', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
      await message.sendMessage('💎 *Gb whatsapp* 💎\GbWhatsapp.\n📌 https://bit.ly/3A47wA0');
    }));   
